...
export const claySoftTheme: VisionTheme = {
  ...
  colors: {
    ...
    dark: {
      background: 'oklch(0.19 0.03 320)',
      foreground: 'oklch(0.94 0.02 315)',
      surface: 'oklch(0.24 0.035 320)',
      surfaceForeground: 'oklch(0.94 0.02 315)',
      accent: 'oklch(0.70 0.12 14)',
      accentForeground: 'oklch(0.16 0.03 320)',
      secondary: 'oklch(0.30 0.04 230)',
      secondaryForeground: 'oklch(0.94 0.02 315)',
      muted: 'oklch(0.26 0.03 318)',
      ...
      chart3: 'oklch(0.74 0.10 120)',
      chart4: 'oklch(0.72 0.10 70)',
      chart5: 'oklch(0.70 0.11 300)',
    },
  },
  artisticPillars: {
