...
export const immersiveTheme: VisionTheme = {
  ...
  colors: {
    light: {
      background: 'oklch(0.97 0.015 258)',
      foreground: 'oklch(0.22 0.04 260)',
      surface: 'oklch(0.99 0.01 255)',
      surfaceForeground: 'oklch(0.22 0.04 260)',
      accent: 'oklch(0.56 0.23 290)',
      accentForeground: 'oklch(0.98 0.01 255)',
      secondary: 'oklch(0.90 0.03 258)',
      secondaryForeground: 'oklch(0.24 0.04 260)',
      muted: 'oklch(0.94 0.02 258)',
      mutedForeground: 'oklch(0.44 0.04 260)',
      border: 'oklch(0.84 0.03 260)',
      input: 'oklch(0.96 0.015 258)',
      ring: 'oklch(0.58 0.20 288)',
      danger: 'oklch(0.55 0.24 25)',
      dangerForeground: 'oklch(0.98 0.01 255)',
      chart1: 'oklch(0.58 0.23 290)',
      chart2: 'oklch(0.58 0.20 202)',
      chart3: 'oklch(0.60 0.20 138)',
      chart4: 'oklch(0.64 0.21 70)',
      chart5: 'oklch(0.58 0.20 18)',
    },
    dark: {
