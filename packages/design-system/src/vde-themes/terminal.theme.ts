...
export const terminalTheme: VisionTheme = {
  ...
  colors: {
    light: {
      ...
      surface: 'oklch(0.99 0.005 145)',
      surfaceForeground: 'oklch(0.22 0.04 150)',
      accent: 'oklch(0.52 0.18 145)',
      accentForeground: 'oklch(0.98 0.01 145)',
      secondary: 'oklch(0.90 0.02 150)',
      secondaryForeground: 'oklch(0.24 0.04 150)',
      muted: 'oklch(0.94 0.015 145)',
      mutedForeground: 'oklch(0.45 0.05 150)',
      border: 'oklch(0.84 0.02 145)',
      input: 'oklch(0.96 0.01 145)',
      ring: 'oklch(0.54 0.18 145)',
      danger: 'oklch(0.55 0.2 30)',
      dangerForeground: 'oklch(0.98 0.01 145)',
      chart1: 'oklch(0.55 0.18 145)',
      chart2: 'oklch(0.58 0.15 170)',
      chart3: 'oklch(0.62 0.15 100)',
      chart4: 'oklch(0.60 0.16 60)',
      chart5: 'oklch(0.58 0.15 20)',
    },
    dark: {
