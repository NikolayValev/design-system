...
export const zenTheme: VisionTheme = {
  ...
  colors: {
    ...
    dark: {
      ...
      foreground: 'oklch(0.93 0.015 145)',
      surface: 'oklch(0.23 0.025 150)',
      surfaceForeground: 'oklch(0.93 0.015 145)',
      accent: 'oklch(0.68 0.11 170)',
      accentForeground: 'oklch(0.16 0.02 150)',
      secondary: 'oklch(0.30 0.025 150)',
      secondaryForeground: 'oklch(0.93 0.01 145)',
      muted: 'oklch(0.26 0.02 150)',
      mutedForeground: 'oklch(0.70 0.03 155)',
      border: 'oklch(0.34 0.025 150)',
      input: 'oklch(0.27 0.02 150)',
      ring: 'oklch(0.70 0.11 170)',
      danger: 'oklch(0.62 0.17 26)',
      dangerForeground: 'oklch(0.97 0.01 150)',
      chart1: 'oklch(0.70 0.11 170)',
      chart2: 'oklch(0.72 0.12 140)',
      chart3: 'oklch(0.74 0.10 90)',
      chart4: 'oklch(0.68 0.09 200)',
      chart5: 'oklch(0.70 0.10 45)',
    },
  },
  artisticPillars: {
