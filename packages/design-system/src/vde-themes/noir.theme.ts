...
export const noirTheme: VisionTheme = {
  ...
  colors: {
    light: {
      ...
      surface: 'oklch(1 0.002 255)',
      surfaceForeground: 'oklch(0.18 0.01 260)',
      accent: 'oklch(0.52 0.11 252)',
      accentForeground: 'oklch(0.98 0.005 255)',
      secondary: 'oklch(0.91 0.01 258)',
      secondaryForeground: 'oklch(0.22 0.01 260)',
      muted: 'oklch(0.94 0.008 258)',
      mutedForeground: 'oklch(0.44 0.01 258)',
      border: 'oklch(0.84 0.01 256)',
      input: 'oklch(0.96 0.006 256)',
      ring: 'oklch(0.54 0.12 252)',
      danger: 'oklch(0.55 0.2 26)',
      dangerForeground: 'oklch(0.98 0.005 255)',
      chart1: 'oklch(0.55 0.12 252)',
      chart2: 'oklch(0.58 0.15 180)',
      chart3: 'oklch(0.60 0.12 80)',
      chart4: 'oklch(0.55 0.15 22)',
      chart5: 'oklch(0.56 0.12 320)',
    },
    dark: {
