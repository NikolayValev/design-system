...
export const brutalistTheme: VisionTheme = {
  ...
  colors: {
    light: {
      ...
      surface: 'oklch(1 0 0)',
      surfaceForeground: 'oklch(0.08 0 0)',
      accent: 'oklch(0.55 0.27 29)',
      accentForeground: 'oklch(0.99 0 0)',
      secondary: 'oklch(0.94 0 0)',
      secondaryForeground: 'oklch(0.12 0 0)',
      muted: 'oklch(0.96 0 0)',
      mutedForeground: 'oklch(0.38 0 0)',
      border: 'oklch(0.08 0 0)',
      input: 'oklch(0.97 0 0)',
      ring: 'oklch(0.12 0 0)',
      danger: 'oklch(0.50 0.24 30)',
      dangerForeground: 'oklch(0.99 0 0)',
      chart1: 'oklch(0.55 0.27 29)',
      chart2: 'oklch(0.52 0.26 240)',
      chart3: 'oklch(0.60 0.23 87)',
      chart4: 'oklch(0.50 0.24 150)',
      chart5: 'oklch(0.48 0.21 335)',
    },
    dark: {
