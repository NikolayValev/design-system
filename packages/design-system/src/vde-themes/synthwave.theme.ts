...
export const synthwaveTheme: VisionTheme = {
  ...
  colors: {
    light: {
      ...
      foreground: 'oklch(0.22 0.05 296)',
      surface: 'oklch(0.99 0.01 292)',
      surfaceForeground: 'oklch(0.22 0.05 296)',
      accent: 'oklch(0.55 0.23 335)',
      accentForeground: 'oklch(0.98 0.01 292)',
      secondary: 'oklch(0.90 0.03 295)',
      secondaryForeground: 'oklch(0.24 0.05 296)',
      muted: 'oklch(0.94 0.02 292)',
      mutedForeground: 'oklch(0.44 0.05 296)',
      border: 'oklch(0.84 0.03 295)',
      input: 'oklch(0.96 0.015 292)',
      ring: 'oklch(0.58 0.23 334)',
      danger: 'oklch(0.55 0.24 20)',
      dangerForeground: 'oklch(0.98 0.01 292)',
      chart1: 'oklch(0.58 0.23 334)',
      chart2: 'oklch(0.58 0.20 215)',
      chart3: 'oklch(0.60 0.22 285)',
      chart4: 'oklch(0.64 0.20 120)',
      chart5: 'oklch(0.60 0.20 60)',
    },
    dark: {
