...
export const y2kChromeTheme: VisionTheme = {
  ...
  colors: {
    ...
    dark: {
      ...
      surface:
        'linear-gradient(115deg, rgba(40,44,54,0.96) 0%, rgba(28,32,42,0.98) 24%, rgba(20,22,30,0.97) 48%, rgba(34,38,50,0.98) 76%, rgba(24,28,38,0.95) 100%)',
      surfaceForeground: 'oklch(0.94 0.015 250)',
      accent: 'oklch(0.74 0.24 336)',
      accentForeground: 'oklch(0.16 0.03 255)',
      secondary: 'oklch(0.30 0.05 210)',
      secondaryForeground: 'oklch(0.94 0.015 250)',
      muted: 'oklch(0.26 0.03 250)',
      mutedForeground: 'oklch(0.70 0.04 250)',
