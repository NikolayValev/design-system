...
export const museumTheme: VisionTheme = {
  ...
  colors: {
    ...
    dark: {
      ...
      surface: 'oklch(0.22 0.025 55)',
      surfaceForeground: 'oklch(0.94 0.01 80)',
      accent: 'oklch(0.68 0.13 42)',
      accentForeground: 'oklch(0.16 0.02 50)',
      secondary: 'oklch(0.30 0.03 55)',
      secondaryForeground: 'oklch(0.94 0.01 80)',
      muted: 'oklch(0.26 0.025 55)',
      mutedForeground: 'oklch(0.70 0.03 60)',
      ...
      chart3: 'oklch(0.66 0.08 230)',
      chart4: 'oklch(0.78 0.17 88)',
      chart5: 'oklch(0.75 0.16 65)',
    },
  },
  artisticPillars: {
