...
export const solarpunkTheme: VisionTheme = {
  ...
  colors: {
    ...
    dark: {
      ...
      surface: 'oklch(0.22 0.035 140)',
      surfaceForeground: 'oklch(0.93 0.02 120)',
      accent: 'oklch(0.66 0.11 145)',
      accentForeground: 'oklch(0.16 0.03 140)',
      secondary: 'oklch(0.30 0.05 50)',
      secondaryForeground: 'oklch(0.93 0.02 120)',
      muted: 'oklch(0.26 0.03 135)',
      mutedForeground: 'oklch(0.70 0.04 140)',
      ...
      chart2: 'oklch(0.72 0.12 50)',
      chart3: 'oklch(0.74 0.13 215)',
      chart4: 'oklch(0.74 0.12 85)',
      chart5: 'oklch(0.72 0.14 22)',
    },
  },
  artisticPillars: {
